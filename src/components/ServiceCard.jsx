  ...
  return (
    ...
    >
      ...
      >
        {IconComponent && (
          <IconComponent
            className={`text-blue-400 group-hover:text-black dark:group-hover:text-white transition-colors duration-300`}
            size={isBento ? 28 : 24}
          />
        )}
      </div>
      ...
      <h3
        className={`font-bold text-black dark:text-white mb-2 lg:mb-3 group-hover:text-blue-300 transition-colors relative z-10 ${isBento ? "text-lg lg:text-xl xl:text-2xl" : "text-xl"}`}
      >
        {title}
      </h3>
