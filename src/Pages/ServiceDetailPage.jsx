      ...
      <main>
        <section className="pt-28 sm:pt-32 lg:pt-40 pb-16 sm:pb-20 overflow-hidden relative">
          ...
          <div className="max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 xl:px-8 relative z-10">
            <Link to="/" className="inline-flex items-center text-sm text-blue-400 hover:underline mb-6">
              ← Back to home
            </Link>
            <div className="max-w-4xl">
              ...
              <p className="text-lg sm:text-xl max-w-3xl leading-relaxed mb-8" style={{ color: "var(--text-secondary)" }}>
                {service.heroDescription}
              </p>
              <div className="flex flex-wrap gap-3">
                <a href="#contact" className="rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white hover:bg-blue-500 transition-colors">
                  Discuss this service
                </a>
                <a
                  href={`mailto:info@quonote.com?subject=${encodeURIComponent(`${service.name} enquiry`)}`}
                  className="rounded-xl border border-slate-700 px-6 py-3 font-semibold hover:border-blue-500 transition-colors"
        ...
        <section className="py-16 sm:py-20 bg-slate-900/50 dark:bg-slate-900/50 light:bg-slate-50">
          <div className="max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 xl:px-8 grid lg:grid-cols-2 gap-10">
            <div className="rounded-3xl border border-slate-800 bg-slate-900/70 light:bg-white p-8">
            ...
            <div className="rounded-3xl border border-slate-800 bg-slate-900/70 light:bg-white p-8">
              ...
              <p className="mt-8 text-sm sm:text-base leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                <span className="font-semibold" style={{ color: "var(--text-primary)" }}>Ideal for:</span> {service.idealFor}
              </p>
            </div>
          </div>
        </section>
