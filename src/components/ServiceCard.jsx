...
const ServiceCard = ({
  ...
  <div className="group floating-card relative p-6 lg:p-7 xl:p-8 bg-slate-900/80 backdrop-blur border border-slate-800 rounded-2xl transition-all duration-300 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-900/20 h-full flex flex-col overflow-hidden">
